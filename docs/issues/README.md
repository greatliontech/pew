...
| [format-rung-two-readers](format-rung-two-readers.md) | the format rung is judged by store.IsRecording and by fingerprintFromConfig, two implementations of one rule | cross-tool train chunk 275 |
