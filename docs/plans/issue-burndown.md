...
- [ ] 2. Stream configuration key poisoning: spec §5 wording for recordable stream keys + enforcement
- [ ] 3. Stale-shape recording visibility: surface shape-failing recordings in `stat`; report/remove in `gc`
