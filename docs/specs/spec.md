...
consumer sees the value, and a continuation without its row line or a gap in the indexes is a corrupt
recording. No value begins in a space or tab (`benchfmt`'s reader strips leading whitespace, so it
